...
<head>
    ...
    <title>Register - Antigravity Engine</title>
    <!-- Google Fonts -->
    ...
    <main class="flex-1 flex flex-col items-center justify-center px-4 py-12">
        <div class="w-full max-w-md relative group">
            ...
            <div class="relative w-full rounded-2xl bg-[#12111a]/80 border border-white/10 backdrop-blur-xl px-8 py-10 shadow-2xl flex flex-col">
                ...
                <p class="text-xs text-center text-gray-500 font-medium tracking-wide mb-8">REGISTER FOR PRIVATE REAL-TIME CHAT</p>
                ...
                <form method="POST" action="/register" class="space-y-4">
                    @csrf
                    <div>
                        <label for="name" class="block text-xs font-semibold uppercase tracking-wider text-gray-500 mb-2">Full Name</label>
                    ...
                    <div>
                        <label for="password_confirmation" class="block text-xs font-semibold uppercase tracking-wider text-gray-500 mb-2">Confirm Password</label>
                ...
                <div class="text-center mt-6 text-xs text-gray-500">
                    ...
                    <a href="/login" class="text-violet-400 hover:text-violet-300 font-semibold transition-colors">Sign in here</a>
                </div>
            </div>
        </div>
    </main>
